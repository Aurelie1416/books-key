<template>
  <section id="connexion">
    ...
    <form method="post" v-on:submit.prevent="formSubmit">
      ...
      <small
        v-bind:class="[
          { inputMessageValid: emailIsValid && email.length > 0 },
      ...
      <div>
        <small class="infoPassword">
          ...
          <span
            v-bind:class="[
              {
                inputMessageValid: numberCaracterIsValid && password.length > 0,
              },
              {
                inputMessageError:
      ...
      <button
        :disabled="
          ...
          password.length == 0
        "
        v-bind:class="[{ buttonActive: emailIsValid && passwordIsValid }]"
      >
        Je me connecte !
      </button>
    </form>
